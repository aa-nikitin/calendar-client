...
import {
  getHallsObj,
  getBookingInfoPrice /*, getBookingInfoPrice, getHallsObj */
} from '../redux/reducers';
// import { loadPriceRequest } from '../redux/actions';
...
const BookingForm = ({ handleClickShowForm }) => {
                  ...
                  return (
                    <div
                      ...
                      <div className="booking-order-form__booking-item-left">
                        {item.date} {item.timeRange},{item.timeBusy}
                      </div>
